...
- [Fine-tuning FunctionGemma for Banking Tool Routing with TRL](notebooks/Finetune_FunctionGemma_Banking77_Tool_Router_with_TRL_Colab.ipynb) ([uv script](scripts/finetune_functiongemma_banking77_colab.py), [model](https://huggingface.co/lxyuan/FunctionGemma-270M-banking77-router))
